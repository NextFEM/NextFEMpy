'''
This examples illustrates a staircase composed by a stringer and a landing.
'''
...
# 'p'
ph = 18.32                  # Load in horizontal projection
pl = ph*cos(atan(1.7/3.0))  # Equivalent load along the element
